...
public final class StructurePlacer {
    ...
    public static void placeInChunk(WorldGenLevel level, List<BlockPos> waypoints, List<Identifier> structureSetIds, HolderSet<Biome> biomes, int chunkX, int chunkZ, RandomSource random, LongOpenHashSet placedPositions, int flags) {
