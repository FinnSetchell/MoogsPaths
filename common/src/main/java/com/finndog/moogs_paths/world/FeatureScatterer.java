...
public final class FeatureScatterer {
    ...
    private static final Set<Identifier> WARNED_MISSING = Collections.synchronizedSet(new HashSet<>());

    public static void scatterInChunk(WorldGenLevel level, ChunkGenerator generator, List<BlockPos> waypoints, List<Identifier> decoratorSetIds, HolderSet<Biome> biomes, int chunkX, int chunkZ, RandomSource random) {
        ...
        for(Identifier id : decoratorSetIds) {
